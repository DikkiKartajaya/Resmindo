<div class="container mt-3">
  <?php if (isset($_SESSION['pesan'])) : ?>
    ...
    <div class="card mb-3">
      <img src="assets/image/posterResmindo.png" class="card-img-top" height="180">
      <div class="card-body">
        <center>
          <h3 class="card-title">WELCOME TO RESMINDO</h3>
          <p class="card-text">We Have Super Delicious Menu In Town</p>
        </center>          
      </div>
    </div>
