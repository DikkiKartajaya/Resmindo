...
<html lang="en">
  <head>
    ...
    <!-- Icon Website -->
    <link rel="icon" type="image/png" href="../dashboard/assets/image/logoResmindo.png">
    <!-- Font Awesome -->
  ...
  <body>
    <nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #C51605;">
      <div class="container">
        <a class="navbar-brand" href="#">
          <img src="assets/image/logoResmindo.png" alt="" width="30" height="30" class="mb-1">
          Resmindo
        </a>
          ...
          <ul class="navbar-nav mr-auto">
            <?php  
              if (isset($_GET['home'])) {
                ...
                $tran = "active";
              } elseif (isset($_GET['beranda'])) {
                $beranda = "active";
              } elseif (isset($_GET['daftarmeja'])) {
                $daftarmeja = "active";
              } else {
                $home = "active";
              }
            ...
            <?php if ($level=="Admin"): ?>
              ...
              <div class="nav-item dropdown <?= $us ?><?= $m ?>">
                <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" role="button" data-toggle="dropdown">Kelola Data</a>
              ...
              <a class="nav-link nav-item <?= $or ?>" href="index.php?order">Data Pesanan<span class="sr-only">(current)</span></a>
              <a class="nav-link nav-item <?= $tran ?>" href="index.php?transaksi">Data Transaksi <span class="sr-only">(current)</span></a>
              <a class="nav-link nav-item <?= $lap ?>" href="index.php?laporan">Laporan <span class="sr-only">(current)</span></a>

            <?php elseif ($level=="Pelayan"): ?>
              <a class="nav-link nav-item <?= $beranda ?>" href="index.php?beranda">Beranda <span class="sr-only">(current)</span></a>
              <a class="nav-link nav-item <?= $daftarmeja ?>" href="index.php?daftarmeja">Daftar Meja <span class="sr-only">(current)</span></a>
              <a class="nav-link nav-item <?= $home ?>" href="index.php">Home <span class="sr-only">(current)</span></a>
              <a class="nav-link nav-item <?= $or ?>" href="index.php?order">Data Pesanan <span class="sr-only">(current)</span></a>
              <a class="nav-link nav-item <?= $lap ?>" href="index.php?laporan">Laporan <span class="sr-only">(current)</span></a>

            <?php elseif ($level=="Kasir"): ?>
              <a class="nav-link nav-item <?= $beranda ?>" href="index.php?beranda">Home <span class="sr-only">(current)</span></a>
              <a class="nav-link nav-item <?= $tran ?>" href="index.php?transaksi">Data Transaksi <span class="sr-only">(current)</span></a>
              <a class="nav-link nav-item <?= $lap ?>" href="index.php?laporan">Laporan <span class="sr-only">(current)</span></a>

            <?php elseif ($level=="Gudang"): ?>
              <a class="nav-link nav-item <?= $beranda ?>" href="index.php?beranda">Home <span class="sr-only">(current)</span></a>
              <a class="nav-link nav-item <?= $m ?>" href="index.php?makanan">Data Menu <span class="sr-only">(current)</span></a>
              </div>
